...
internal fun isNotZero(value: BigDecimal): ValidationResult = buildValidationResult(
    ...
    DeferredText.Resource(com.backbase.android.business.app.universal.R.string.amount_blank)
)

internal fun isAmountRequired(value: BigDecimal): ValidationResult = buildValidationResult(
    value.compareTo(BigDecimal.ZERO) != 0,
    DeferredText.Resource(com.backbase.android.business.app.universal.R.string.payment_wizard_amount_required)
)

internal fun deliveryOptionsNotEmpty(value: String): ValidationResult = buildValidationResult(
    value.isNotEmpty(),
    DeferredText.Resource(com.backbase.android.business.app.universal.R.string.international_delivery_options_error)
)

internal fun isNotEmpty(value: String): ValidationResult = buildValidationResult(
    value.isNotBlank(),
    DeferredText.Resource(com.backbase.android.business.app.universal.R.string.error_beneficiary_empty)
)


internal fun isValidIban(iban: String): ValidationResult = buildValidationResult(
    validateIban(iban),
    DeferredText.Resource(com.backbase.android.business.app.universal.R.string.sepa_error_invalid_iban)
)
...
internal fun chargeBearerNotEmpty(value: String): ValidationResult = buildValidationResult(
    value.isNotEmpty(),
    DeferredText.Resource(com.backbase.android.business.app.universal.R.string.international_charge_bearer_validation_error)
)

internal fun chargeBearerNotEmpty(value: String, @StringRes errorMessage: Int): ValidationResult =
    buildValidationResult(
        value.isNotEmpty(),
        DeferredText.Resource(errorMessage)
    )

internal fun countryNotEmpty(value: String): ValidationResult = buildValidationResult(
    value.isNotEmpty(),
    DeferredText.Resource(com.backbase.android.business.app.universal.R.string.country_required)
)