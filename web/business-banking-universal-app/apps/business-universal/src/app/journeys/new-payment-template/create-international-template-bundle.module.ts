...
const internationalTemplateConfig: InitiatePaymentConfig = {
  paymentTypes: [
    {
      ...INTERNATIONAL_TRANSFER,
  ...
  businessFunctions: [INTERNATIONAL_TRANSFER.businessFunction as string],
  options: {
    isTemplateMode: true,
    paymentMode: PaymentMode.CREATE_TEMPLATE,
    defaultCountry: 'NL',
  },
};
...
@NgModule({
  ...
  providers: [
    ...
    { provide: INITIATE_PAYMENT_CONFIG, useValue: internationalTemplateConfig },
    {
...
export class NewTemplateInternationalWireJourneyBundleModule {}
