...
export const APP_CASH_MANAGEMENT_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_CASH_MANAGEMENT_BASE_PATH',
);
...
export const APP_ACTIONS_BASE_PATH = new InjectionToken<string>(
  'ServicePathsModule::APP_ACTIONS_BUSINESS_UNIVERSAL_BASE_PATH',
);
...
export const APP_TRADINGFX_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_TRADINGFX_BASE_PATH');
...
@NgModule({
  providers: [
    ...
    {
      provide: APP_CASH_MANAGEMENT_BASE_PATH,
      useValue: `${environment.apiRoot}/cash-management-presentation-service`,
    },
    {
    ...
    {
      provide: APP_TRADINGFX_BASE_PATH,
      useValue: `${environment.apiRoot}/tradingfx-presentation-service`,
    },
  ],
})
